...
public class OSMMapReaderTest {
    ...
    public void joinedBuildings() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testJoinedBuildings.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void roads() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testRoads.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void multipolygons() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testMultipolygons.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void DataCorrupted() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testDataCorrupted.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void typeLessRelations() {
        ...
        final String attr = "";
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testTypelessRelations.osm").getFile(), false);
        } catch (Exception e) {
    ...
    public void gzipIsRespected(){
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testGZip.osm.gz").getFile(), true);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        assertEquals(5, testMapReadResult.ways().size());
    ...
    public void onlyDefinedAttsUsed(){
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testUndefinedAtts.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        assertEquals(4, testMapReadResult.ways().size());
    ...
    public void learningCenter() {
    	try {
			OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/lc.osm.gz").getFile(), true);
		} catch (Exception e) {
		    fail("Unable to recognise the file and/or read it properly.");
		}
    }
    ...
    public void errorInFile() throws Exception{
        OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testSimpleBuildingError.osm").getFile(), false);
    }
