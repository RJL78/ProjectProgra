package test.ch.epfl.imhof.osm;
...
public class OSMToGeoTransformerTest {
    ...
    public void simpleBuilding() {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testSimpleBuilding.osm").getFile(), false);
        } catch (Exception e) {
    ...
    public void closedWayWithoutAttributeIsFiltered() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testWaysNoAttribute.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void closedWayWithAreaAttribute() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testWaysWithAreaAttribute.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void closedWayWithAttributes() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testWaysWithAttributes.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void severalWallsTwoHoles() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testSeveralWalls.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void roadWhole() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testRoadWhole.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void joinedBuildingsFromRelation() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testJoinedBuildingsFromRelation.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void joinedBuildingsFromClosedWay() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testJoinedBuildingsFromClosedWay.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void buildingOnALandUse() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testBuildingOnALandUse.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void buildingOneInnerHole() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testBuildingOneInnerHole.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void buildingMultipleHoles() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testBuildingMultipleHoles.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void notMultipolygon() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testNotMultipolygon.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void orphanInnerRing() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testOrphanInnerRing.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void tooManyNeighbors() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testTooManyNeighbors.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void roadCorrupted() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testRoadCorrupted.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void joinedBuildingsTaggedRelation() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testJoinedBuildingsTaggedRelation.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void BuildingInsideBuilding() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testBuildingInsideBuilding.osm").getFile(), false);
        } catch (Exception e) {
    ...
    public void MultipleBuildingsInOneRelation() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testMultipleBuildingsInOneRelation.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void PolygonRelationsToKeep() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testPolygonRelationsToKeep.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void PolylineKeysToKeep() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/data/OSMtestFiles/testPolylineKeysToKeep.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
