...
/** 
 * Classe Immuable modelisant un point dans le repere WGS84
 * 
...
public final class PointGeo {
     ...
     *
     * @throws IllegalArgumentException : Lancée si la longitude et la latitude mis en paramètre n'appartiennent pas
